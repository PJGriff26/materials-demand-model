...
└── docs/                         # Documentation
    ...
    ├── data_sources.csv              # Input data files & sheets
...
#### 2. **`data_sources.csv`** (9 entries) — NEW March 2026
**Purpose:** Documents all INPUT data files and their structure

**Contents:**
- `intensity_data.csv` — Material intensity values by technology
- `StdScen24_annual_national.csv` — NREL capacity projections
- `risk_charts_inputs.xlsx` — Supply chain risk data (multi-sheet workbook)
  - Individual sheet descriptions (aggregate, import_dependency, import_shares, reserves, crc)
- `mcs2023-*_salient.csv` — USGS material-specific data files
